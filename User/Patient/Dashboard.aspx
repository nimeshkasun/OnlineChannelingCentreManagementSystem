<%@ Page Title="Patient Dashboard" Language="C#" MasterPageFile="~/User/User.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="User_Admin_Dashboard" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br />
    <div>
        <asp:Button ID="Button3" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Blood Report" Width="240px" />
        <asp:Button ID="Button4" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Cholestrol Report" Width="240px" />
        <asp:Button ID="Button5" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Urine Report" Width="240px" />
    </div>
    <div style="border: 5px solid #FFFFFF">
        ...
        <asp:SqlDataSource ID="LabReport" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT * FROM [Labreport] WHERE ([Patient_ID] = @Patient_ID)">
            <SelectParameters>
                <asp:SessionParameter Name="Patient_ID" SessionField="Patient_ID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                    ...
                    <caption>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%"><div class="wrap-input100 validate-input">
                                <asp:DropDownList ID="DropDownList1" CssClass="input100" runat="server" DataSourceID="BTDoc" DataTextField="First_name" DataValueField="Doctor_ID" Height="30px" Width="100%" Enabled="False">
                            ...
                            <td>
                                <div style="text-align: right;">
                                    <br />
                                    <asp:Button ID="Button9" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="New" Width="100px" OnClick="Button9_Click" Visible="False" />
                                    <br />
                                </div>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 8%"><div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="DropDownList3" CssClass="input100"  runat="server" Height="30px" Width="100%" Enabled="False">
                        ...
                        <td style="width: 11%"><div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="DropDownList4"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                        ...
                        <td style="width: 7%"><div class="wrap-input100 validate-input" style="width: 150%">
                            <asp:DropDownList ID="DropDownList6"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                <asp:ListItem>1930</asp:ListItem>
                                <asp:ListItem>1931</asp:ListItem>
                                <asp:ListItem>1932</asp:ListItem>
                                <asp:ListItem>1933</asp:ListItem>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox2" CssClass="input100"   placeholder="Red Blood Cells" runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox3"  CssClass="input100" placeholder="White Blood Cells"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox5"  CssClass="input100"  placeholder="Glucose" runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">
                    ...
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox6"  CssClass="input100" placeholder="Himoglobin"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox8" CssClass="input100"  placeholder="Platelets"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 20%" rowspan="2"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox7"  CssClass="input100" placeholder="Other Notes"  runat="server" BorderStyle="None" Width="100%" TextMode="MultiLine" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="text-align: right;">
                                ...
                                <asp:Button ID="Button6" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Update" Width="100px" OnClick="Button6_Click" Visible="False" />
                                <br />
                            </div>
                        </td>
                    </tr>
                ...
                <table style="width: 100%;">
                    <caption>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%"><div class="wrap-input100 validate-input">
                                <asp:DropDownList ID="DropDownList7"  CssClass="input100" runat="server" DataSourceID="BTDoc" DataTextField="First_name" DataValueField="Doctor_ID" Height="30px" Width="100%" Enabled="False">
                                </asp:DropDownList><span class="focus-input100"></span>
</div>
                            ...
                            <td>
                                <div style="text-align: right;">
                                    <br />
                                    <asp:Button ID="Button7" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="New" Width="100px" OnClick="Button7_Click" Visible="False" />
                                    <br />
                                </div>
            ...
            <div>
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 8%"><div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="DropDownList10"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                <asp:ListItem>1</asp:ListItem>
                                <asp:ListItem>2</asp:ListItem>
                                <asp:ListItem>3</asp:ListItem>
                                <asp:ListItem>4</asp:ListItem>
                        ...
                        <td style="width: 10px">&nbsp;</td>
                        <td style="width: 11%"><div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="DropDownList11" CssClass="input100"  runat="server" Height="30px" Width="100%" Enabled="False">
                                <asp:ListItem>January</asp:ListItem>
                                <asp:ListItem>February</asp:ListItem>
                                <asp:ListItem>March</asp:ListItem>
                                <asp:ListItem>April</asp:ListItem>
                        ...
                        <td style="width: 10px">&nbsp;</td>
                        <td style="width: 7%"><div class="wrap-input100 validate-input" style="width: 150%">
                            <asp:DropDownList ID="DropDownList12"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                <asp:ListItem>1930</asp:ListItem>
                                <asp:ListItem>1931</asp:ListItem>
                                <asp:ListItem>1932</asp:ListItem>
                                <asp:ListItem>1933</asp:ListItem>
            ...
            <div>
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox9"  CssClass="input100"  placeholder="Low-Density Lipoprotein" runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox10"  CssClass="input100" placeholder="High-Density Lipoprotein"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox11"  CssClass="input100"  placeholder="Triglicerides" runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox12" CssClass="input100"   placeholder="VLDL Cholesterol" runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox13"  CssClass="input100" placeholder="Total Cholesterol"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td style="width: 20%" rowspan="2"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox19"  CssClass="input100"  placeholder="Other Notes" runat="server" BorderStyle="None" Width="100%" TextMode="MultiLine" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="text-align: right;">
                                ...
                                <asp:Button ID="Button11" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Update" Width="100px" OnClick="Button11_Click" Visible="False" />
                                <br />
                            </div>
                        </td>
                    </tr>
                ...
                <table style="width: 100%;">
                    <caption>
                        ...
                        <tr>
                            ...
                            <td style="width: 25%"><div class="wrap-input100 validate-input">
                                <asp:DropDownList ID="DropDownList13"  CssClass="input100" runat="server" DataSourceID="BTDoc" DataTextField="First_name" DataValueField="Doctor_ID" Height="30px" Width="100%" Enabled="False">
                                </asp:DropDownList><span class="focus-input100"></span>
</div>
                            ...
                            <td>
                                <div style="text-align: right;">
                                    <br />
                                    <asp:Button ID="Button8" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="New" Width="100px" OnClick="Button8_Click" Visible="False" />
                                    <br />
                                </div>
            ...
            <div>
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 8%"><div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="DropDownList14"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                <asp:ListItem>1</asp:ListItem>
                                <asp:ListItem>2</asp:ListItem>
                                <asp:ListItem>3</asp:ListItem>
                                <asp:ListItem>4</asp:ListItem>
                        ...
                        <td style="width: 10px">&nbsp;</td>
                        <td style="width: 11%"><div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="DropDownList15"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                <asp:ListItem>January</asp:ListItem>
                                <asp:ListItem>February</asp:ListItem>
                                <asp:ListItem>March</asp:ListItem>
                                <asp:ListItem>April</asp:ListItem>
                        ...
                        <td style="width: 10px">&nbsp;</td>
                        <td style="width: 7%"><div class="wrap-input100 validate-input" style="width: 150%">
                            <asp:DropDownList ID="DropDownList16"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                <asp:ListItem>1930</asp:ListItem>
                                <asp:ListItem>1931</asp:ListItem>
                                <asp:ListItem>1932</asp:ListItem>
                                <asp:ListItem>1933</asp:ListItem>
            ...
            <div>
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox16"  CssClass="input100"  placeholder="Glucose" runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox17" placeholder="Protine"  CssClass="input100" runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox18" CssClass="input100"  placeholder="Crystal"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">
                        ...
                        <td style="width: 20%"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox20" CssClass="input100"  placeholder="Acidity"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 20%" rowspan="2"><div class="wrap-input100 validate-input">
                            <asp:TextBox ID="TextBox23" CssClass="input100"  placeholder="Other Notes"  runat="server" BorderStyle="None" Width="100%" TextMode="MultiLine" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                        </td>
                        <td>&nbsp;</td>
                        <td style="width: 15%">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="text-align: right;">
                                ...
                                <asp:Button ID="Button13" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Update" Width="100px" OnClick="Button13_Click" Visible="False" />
                                <br />
                            </div>
                        </td>
                    </tr>
    ...
    <div>
        ...
        <div>
            <div>
                <asp:Button ID="Button14" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Prescription" Width="240px" />
                    ...
                    <table style="width: 100%;">
                        <caption>
                            ...
                            <tr>
                                ...
                                <td style="width: 25%"><div class="wrap-input100 validate-input">
                                    <asp:DropDownList ID="DropDownList17"  CssClass="input100" runat="server" DataSourceID="BTDoc" DataTextField="First_name" DataValueField="Doctor_ID" Height="30px" Width="100%" Enabled="False">
                                    </asp:DropDownList><span class="focus-input100"></span>
</div>
                ...
                <div>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 8%"><div class="wrap-input100 validate-input">
                                <asp:DropDownList ID="DropDownList18"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                    <asp:ListItem>1</asp:ListItem>
                                    <asp:ListItem>2</asp:ListItem>
                                    <asp:ListItem>3</asp:ListItem>
                                    <asp:ListItem>4</asp:ListItem>
                            ...
                            <td style="width: 10px">&nbsp;</td>
                            <td style="width: 11%"><div class="wrap-input100 validate-input">
                                <asp:DropDownList ID="DropDownList19"  CssClass="input100" runat="server" Height="30px" Width="100%" Enabled="False">
                                    <asp:ListItem>January</asp:ListItem>
                                    <asp:ListItem>February</asp:ListItem>
                                    <asp:ListItem>March</asp:ListItem>
                                    <asp:ListItem>April</asp:ListItem>
                            ...
                            <td style="width: 10px">&nbsp;</td>
                            <td style="width: 7%"><div class="wrap-input100 validate-input" style="width: 150%">
                                <asp:DropDownList ID="DropDownList20" CssClass="input100"  runat="server" Height="30px" Width="100%" Enabled="False">
                                    <asp:ListItem>1930</asp:ListItem>
                                    <asp:ListItem>1931</asp:ListItem>
                                    <asp:ListItem>1932</asp:ListItem>
                                    <asp:ListItem>1933</asp:ListItem>
                ...
                <div>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 20%"><div class="wrap-input100 validate-input">
                                <asp:DropDownList ID="DropDownList21"  CssClass="input100" runat="server" DataSourceID="Medi" DataTextField="Medicine" DataValueField="Medicine" Height="30px" Width="100%" Enabled="False">
                                </asp:DropDownList><span class="focus-input100"></span>
</div>
                            ...
                            <td style="width: 20%"><div class="wrap-input100 validate-input">
                                <asp:TextBox ID="TextBox22" CssClass="input100" placeholder="Dosage"  runat="server" BorderStyle="None" Width="100%" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 20%" rowspan="2"><div class="wrap-input100 validate-input">
                                <asp:TextBox ID="TextBox27"  CssClass="input100" placeholder="Notes" runat="server" BorderStyle="None" Width="100%" TextMode="MultiLine" Enabled="False"></asp:TextBox><span class="focus-input100"></span>
</div>
                            </td>
                            <td>&nbsp;</td>
                            <td style="width: 15%">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="text-align: right;">
                                    <br />
                                    <asp:Button ID="Button17" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Insert" Width="130px" OnClick="Button17_Click" Visible="False"  />
                                    <asp:Button ID="Button16" CssClass="login100-form-btn" runat="server" BackColor="Blue" BorderStyle="None" ForeColor="White" Height="35px" Text="Insert &amp; New" Width="130px" OnClick="Button16_Click" Visible="False"   />
