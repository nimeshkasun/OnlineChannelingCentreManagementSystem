...
<body>
    ...
    <div>
                    ...
                    <table style="width:100%; ">
                        <tr>
                            ...
                            <td rowspan="2" style="width: 20%;">
                                <asp:Label ID="bGroup" runat="server" style="text-align:center;" BackColor="Red" BorderColor="Red" BorderStyle="Solid" BorderWidth="10px" Font-Bold="True" ForeColor="White" Text="N/A" Font-Size="X-Large" Width="50px" ></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 42px">
                    ...
                    <table style="border: 5px solid #FFFFFF; width:100%; text-align:left;">
                        <tr>
                            <td colspan="2" style="width: 52px">
                                 <br />
                                <asp:Label ID="lblAddress" runat="server" Text="N/A" Font-Bold="True"></asp:Label>
                                <br /><br />
                            </td>
                        </tr>
                        <tr>
        ...
        <div style="text-align:center;">
            ...
            <asp:Button ID="Button2" CssClass="login100-form-btn" runat="server" Text="Print" BackColor="Blue" ForeColor="White" Height="35px" Width="200px" OnClick="Button2_Click" />
            <br />
        </div>
    </form>
</body>
