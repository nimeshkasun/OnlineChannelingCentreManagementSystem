...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div>
        <table style="width: 100%;">
            ...
            <tr>
                <td class="auto-style2"><div class="wrap-input100 validate-input">
                    <asp:DropDownList ID="DropDownList12"  CssClass="input100" placeholder="Specialized Area"  runat="server" Height="30px" Width="100%" DataSourceID="Spec_data" DataTextField="Specialization" DataValueField="Specialization" Enabled="False">
