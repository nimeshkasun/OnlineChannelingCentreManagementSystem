...
<%--    DataSourceID="SqlDataSource1"--%>
    ...
    <div><asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False"  OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
        <Columns>
            ...
            <asp:BoundField DataField="Channel_no" HeaderText="Channel No" ReadOnly="True" SortExpression="Channel_no" ItemStyle-HorizontalAlign="Center" />
        ...
        <%--<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT Channel_no, Patient_ID, Doctor_ID, chan_date FROM Channel WHERE (Doctor_ID = @Doctor_ID) ORDER BY chan_date DESC">
            <SelectParameters>
                <asp:SessionParameter Name="Doctor_ID" SessionField="Doctor_ID" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>--%>
        </div>
    <div>
